...
const SvgRulerPen = (props: SvgProps) => (
  ...
  >
    <path
      ...
      strokeLinecap="round"
    />
    <path d="M11.47 6H16.47" stroke="#AEABA4" strokeLinecap="round" />
    <path d="M11.47 18H15.47" stroke="#AEABA4" strokeLinecap="round" />
    <path d="M11.47 13.95L16.47 14" stroke="#AEABA4" strokeLinecap="round" />
    <path d="M11.47 10H14.47" stroke="#AEABA4" strokeLinecap="round" />
    <path
      ...
      strokeLinecap="round"
    />
    <path d="M8.44003 7H2.53003" stroke="#AEABA4" strokeLinecap="round" />
  </svg>
);
